...
$orgName = $index % 2 ? 'OSIS' : 'Ekstrakurikuler '.($major === 'RPL' ? 'Programming' : 'Desain Grafis');
            DB::table('organizations')->updateOrInsert(['student_id' => $profile->id, 'name' => $orgName], ['organization_name' => $orgName, 'position' => $index % 2 ? 'Anggota' : 'Koordinator', 'started_at' => now()->subYear(), 'ended_at' => null, 'updated_at' => now(), 'created_at' => now()]);
